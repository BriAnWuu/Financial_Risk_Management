...
We will introduce **Filtered Historical Simulation (Scaled model)**, which is an adaptation of its first generation, Historical Simulation (Unscaled model). Filtered Historical Simulation models scale the historical data based on some estimate of current conditions and have [demonstrated improved risk estimates](https://www.bankofengland.co.uk/-/media/boe/files/working-paper/2015/filtered-historical-simulation-value-at-risk-models-and-their-competitors.pdf) compared to the first generation VaR. Thus these models have become widely used by financial institutions.  
