...
### GARCH Coefficients
For time step $t=1$ (Evaluation Date + 1) of the $i$th simulation, where $\sigma$ is known on Evaluation Date:
$$\hat{R}_{i,1} = \sigma_{1}\hat{z}_{i,1}, \text{with } z \sim{N(0,1)} $$
