...
where:  
    $R_{n}$ = unknown rate  
    $R_{1}$ = rate for the shorter designated maturity (nearest to the reset date)  
    $R_{2}$ = rate for the longer designated maturity (nearest to the reset date)  
    $t_{n}$ = number of calendar days to expiry of option  
    $t_{1}$ = number of calendar days to the shorter designated maturity  
    $t_{2}$ = number of calendar days to the longer designated maturity  
```{r}
rates <- rep(0, n)
